...
const LeftSideBar = () => {
  return (
    <div className="flex justify-center items-center transition-all duration-[450ms] ease-in-out w-fit md:w-16 sticky top-1/3 h-fit  md:h-96">
      <div className="flex md:inline-block md:border md:border-solid md:border-gray-700 w-full ease-in-out duration-500 left-0 rounded-2xl  md:shadow-lg md:shadow-black/15 bg-white  md:dark:bg-gradient-to-b md:dark:from-jet md:dark:to-raisin_black">
        <Link
          to="/"
