...
const LeftSideBar = () => {
  return (
    <div className="flex flex-col justify-center items-center transition-all duration-[450ms] ease-in-out w-16 sticky top-1/3 h-96">
      <article className="border border-solid border-gray-700 w-full ease-in-out duration-500 left-0 rounded-2xl inline-block shadow-lg shadow-black/15 bg-gradient-to-b from-white to-seashell dark:bg-gradient-to-b dark:from-jet dark:to-raisin_black">
