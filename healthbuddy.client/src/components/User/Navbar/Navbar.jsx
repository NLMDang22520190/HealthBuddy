        ...
        <div className="flex gap-2 items-center">
          ...
          <label className="inline-flex items-center relative">
            <input
              ...
              type="checkbox"
              checked={isDarkTheme}
              onChange={onToggleTheme} // Gọi hàm onToggleTheme khi switch được nhấn
            />
          ...
          {user ? (
            // Hiển thị nút Logout nếu user không null
            <button className="group flex items-center justify-start size-12 bg-compleprimary-dark rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-32 hover:rounded-lg active:translate-x-1 active:translate-y-1">
