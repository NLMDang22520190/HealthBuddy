...
const FollowWorkoutScheduleModal = ({
  open,
  onCancel,
  onFollow,
  isLoading = false,
  workoutScheduleName = "Workout Schedule"
}) => {
    ...
    <Modal
      title={
        <div className="flex items-center gap-2">
          ...
          <span>Follow Workout Schedule</span>
        </div>
      }
      open={open}
      onCancel={onCancel}
      ...
      >
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
          <Label className="text-sm text-blue-700 dark:text-blue-300">
            💡 <strong>Note:</strong> Once you follow this workout schedule, tracking records will be automatically created for each day of the schedule.
          </Label>
        </div>
      </motion.div>
    </Modal>
...
export default FollowWorkoutScheduleModal;
