...
const HomeMainBar = () => {
  ...
  const fetchPosts = async () => {
    try {
      ...
      // Ánh xạ (map) dữ liệu theo cấu trúc yêu cầu
      const mappedPosts = data.map((post) => ({
        id: post.postId, // ánh xạ postId thành id
        title: post.title, // ánh xạ title
        content: post.description, // ánh xạ description thành content
        image: post.imgUrl, // ánh xạ imgUrl thành image
        user: {
          id: post.uploader.userId, // ánh xạ userId thành id của user
          name: post.uploader.username, // ánh xạ username thành name của user
          avatar: post.uploader.avatar, // ánh xạ avatar
        },
        numberOfLikes: post.numberOfLikes, // ánh xạ numberOfLikes
        numberOfComments: post.numberOfComments, // ánh xạ numberOfComments
        postDate: post.createdDate, // ánh xạ createdDate thành postDate
        type: post.postType, // ánh xạ postType thành type
      }));
